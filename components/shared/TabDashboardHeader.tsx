      ...
      options={{
        ...
        headerRight: () => (
          <Box className="flex flex-row mr-5">
            ...
            {
              // TODO: Make profile image dynamic
              // - Fetch user profile image from API/user context
              // - Add fallback for missing profile images
              // - Consider using a proper avatar component
              // - Handle loading states and error cases
            }
            <Button
              variant="link"
              onPress={() => Alert.alert("testing2")}
              className="ml-3"
            >
              <Avatar>
                <AvatarImage

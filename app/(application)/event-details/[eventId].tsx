      ...
      <VStack className="flex-1 gap-2 mt-4">
          ...
          <VStack className="gap-4">
            <HStack className="gap-4 flex items-center">
              ...
              <Badge action="success">
                <BadgeText className="text-2xs">{STATUS}</BadgeText>
              </Badge>
            </HStack>
            ...
            <Button size="lg" className="bg-pivot rounded-full mb-2">
              <ButtonIcon
                as={NotepadText}
        ...
        <HStack className="gap-2 px-4">
          <Button
            ...
            size="lg"
            variant="outline"
            className="flex-[0.6] rounded-full border-pivot bg-white"
            onPress={handleFeedbacksSheetOpen}
          >
            <ButtonIcon className="text-orange-500" as={NotepadText} />
            <ButtonText className="text-orange-500">Feedbacks</ButtonText>
          </Button>
          <Button
            size="lg"
            className="flex-[0.4] rounded-full bg-pivot"
